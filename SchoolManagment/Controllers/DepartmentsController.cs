...
namespace SchoolManagment.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string SearchValue)
        {
            ...
            {
                var departments = await _context.Departments.ToListAsync(); // Await the ToListAsync() method
                return departments != null ?
                    View(departments) :
                    Problem("Entity set 'SchoolDbContext.Departments' is null.");
            }
            else
            {
                var result = await _context.Departments
                    .Where(D => D.Name.ToLower().Contains(SearchValue.ToLower()))
                    .ToListAsync();
                return View(result);
            }
        }
